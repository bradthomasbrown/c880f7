...
export default function permit(includeSelector: boolean, ...parameters: ParameterOverloads[0]): ArrayBuffer;
export default function permit(includeSelector: boolean, ...parameters: ParameterOverloads[1]): ArrayBuffer;
