...
export default function permitWitnessTransferFrom(includeSelector: boolean, overload: 0, permit: {
    permitted: {
        token: string;
        amount: bigint;
    };
...
}, owner: string, witness: ArrayBuffer, witnessTypeString: string, signature: ArrayBuffer): ArrayBuffer;
export default function permitWitnessTransferFrom(includeSelector: boolean, overload: 1, permit: {
    permitted: Array<{
        token: string;
        amount: bigint;
    }>;
