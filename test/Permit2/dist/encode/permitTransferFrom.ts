...
export default function permitTransferFrom(includeSelector: boolean, ...parameters: ParameterOverloads[0]): ArrayBuffer;
export default function permitTransferFrom(includeSelector: boolean, ...parameters: ParameterOverloads[1]): ArrayBuffer;
