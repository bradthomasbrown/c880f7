...
export default function permitTransferFrom(overload: 0, buffer: ArrayBuffer): ReturnOverloads[0];
export default function permitTransferFrom(overload: 1, buffer: ArrayBuffer): ReturnOverloads[1];
export default function permitTransferFrom(overload: number, buffer: ArrayBuffer): any {
