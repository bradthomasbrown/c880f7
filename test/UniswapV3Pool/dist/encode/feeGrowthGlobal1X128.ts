...
export default function feeGrowthGlobal1X128(includeSelector: boolean, overload: 0): ArrayBuffer;
export default function feeGrowthGlobal1X128(includeSelector: boolean, overload: number, ...parameters: any): ArrayBuffer {
