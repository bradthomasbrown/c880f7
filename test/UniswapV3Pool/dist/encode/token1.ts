...
export default function token1(includeSelector: boolean, overload: 0): ArrayBuffer;
export default function token1(includeSelector: boolean, overload: number, ...parameters: any): ArrayBuffer {
